          ...
          <div className="flex items-center space-x-4 flex-1">
            ...
            <div className="max-w-[400px] w-full relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <svg className="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
              </div>
              <input type="text" className="w-full bg-[#f1f5f9] border border-transparent text-[14px] rounded-lg pl-9 pr-4 py-2 focus:outline-none focus:ring-1 focus:ring-[#00829B] focus:bg-white placeholder:text-gray-400" placeholder="Search features, customers, events..." />
            </div>
          </div>
          <div className="flex items-center space-x-5">
            <button className="text-gray-400 hover:text-gray-600"><svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg></button>
